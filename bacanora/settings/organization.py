...
TACC_API_SERVER = os.environ.get('TACC_API_SERVER',
                                 'https://api.' + DNS_DOMAIN + '/')
TACC_JUPYTER_SERVER = os.environ.get('TACC_JUPYTER_SERVER',
                                     'https://jupyter.' + DNS_DOMAIN)

TACC_PRIMARY_STORAGE_SYSTEM = os.environ.get('TACC_PRIMARY_STORAGE_SYSTEM',
                                             'data-sd2e-community')
